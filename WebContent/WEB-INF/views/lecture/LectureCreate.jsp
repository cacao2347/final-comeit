...
<link rel="stylesheet" type="text/css"
	href="<%=cp%>/assets/css/lecture/lectureCreate.css">
<link rel="stylesheet" type="text/css"
	href="<%=cp%>/assets/css/common/join.css">
<link rel="stylesheet"
				...
				<div class="col-md-8">
					...
					<div class="lecTitle">
						<input type="text" class="studyTitle form-control" id="lecName"
							name="lecName" placeholder="강의 제목을 입력해 주세요." /> <span
							class="titleErr"> 제목은 필수 입력항목입니다. </span>
					</div>
					<!-- end div.lecTitle -->
					...
					<div class="lecContent">
						<textarea id="lecIntro" name="lecIntro" class="form-control"
							rows="8" placeholder="강의를 소개해주세요. "></textarea>
					...
					<div class="period">
						...
						<input type="text" class="start form-control" id="start"
							name="start" placeholder="ex) 시작날짜를 선택하세요." readonly="readonly" />
					...
					<div class="weekDay">
						<select name="week" id="week" class="weekSel form-control">
							...
							id="dayAddBtn" readonly="readonly" /> <input type="button"
							value="초기화" class="weekBtn btn btn-primary" id="dayResetBtn" />
					...
					<div class="button">
						...
						<!-- end .cancel -->
						<div class="upload">
							<input type="button" name="insertBtn" id="insertBtn" value="개설"
