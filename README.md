...
## 1. 사이트 소개
 ...
 IT 관련 강의를 개설할 수 있고 일반 회원은 강의에 참여할 수 있습니다. 세번쨰는 업체 게시판으로 카페나 스터디카페를 운영하는 업체 회원이 스터디 모임을 가질 수 있는 공간을 제공해주는 게시판 입니다. 오프라인으로 스터디/강의 모임을 가질 경우사이트에 등록된 카페/스터디카페를 예약 할 수 있도록 기획하였습니다.
...
* ### 프로젝트 Git 주소 : https://github.com/rhswl1023/final-comeit (해당 주소로 가시면 Commit 내역을 보실 수 있습니다.)
